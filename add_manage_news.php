...
{
	$title=$_POST['title'];
	$checkIfExist = "select * from tbl_event_news where title='".$title."'";
...
//**********file upload trailer*********
  ...
  //***********file Upload End**************** //
	...
	$dbcon->insert_query("tbl_event_news",$content);
...
<div id="body-wrapper">
  ...
  <div id="main-content">
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%">
      <tbody>
        <tr>
          <td class="content-box-header"><b style='font-size:15px;'>Add Event News</b></td>
        </tr>
      </tbody>
    </table>
