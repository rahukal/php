<?
...

	 {
	   ...
	   if($_POST['changeStatus']=='delete') 

		{
		   ...
		   $dbcon->execute_query("delete from tbl_newsletter where newsletter_id in($id)");

		   $mess="Record deleted successfully.";

		   echo "<SCRIPT language=\"JavaScript\">window.location=\"manage_newsletter.php?mess=".base64_encode($mess)."\";</SCRIPT>";
...

		{
		   ...
		   $dbcon->execute_query("update tbl_newsletter set status='active' where newsletter_id in($id)");
...

		{
		   ...
		   $dbcon->execute_query("update tbl_newsletter set status='inactive' where newsletter_id in($id)");
	...
	$sql="select * from tbl_newsletter where 1";
	...
	if($orderBy=="") { 	$orderBy = "newsletter_id"; }
    ...
    <div id="body-wrapper"> <!-- Wrapper for the radial gradient background -->
     ...
     <div id="main-content"> <!-- Main Content Section with everything -->
		...
		<div class="align-left">Records Per Page:
			...
			<select name="pagesize" id="pagesize" onchange="location.href='manage_newsletter.php?&pagesize='+this.value">
			...
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
			  ...
			  <tr>
				...
				<td class="content-box-header">
					...
					<b style='font-size:15px;'>E-mail Management</b> 
  ...
  if($countrecord>0) {
    ...
    ?>
		  ...
		  <tr>
              ...
              <th align="left" width="20%" bgcolor="#FFFFFF"><strong>Email</strong></th>
			  ...
			  <tr>
             	  ...
             	  <td bgcolor='<?=$CL?>'><? echo $records['newsletter_email'];?></td>
