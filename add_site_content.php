...
{
	$name=$_POST['name'];
	$checkIfExist = "select * from tbl_site_content_category where name='".$name."'";
	...
	$dbcon->insert_query("tbl_site_content_category",$content);
...
<div id="body-wrapper">
  ...
  <div id="main-content">
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%">
      <tbody>
        <tr>
          <td class="content-box-header"><b style='font-size:15px;'>Add site category</b></td>
        </tr>
      </tbody>
    </table>
