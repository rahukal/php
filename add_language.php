...
<div id="body-wrapper">
  ...
  <div id="main-content">
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%">
      <tbody>
        <tr>
          <td class="content-box-header"><b style='font-size:15px;'>Add language</b></td>
        </tr>
      </tbody>
   </table>
        ...
        <tr>
          <td><table width="100%"  border="0" cellspacing="7" cellpadding="3" >
			  ...
			  <tr>
                ...
                <td width="81%" height="25" valign="top" ><input type="search" name="language_name" id="language_name" class="txtbox" required="required" /></td>
              </tr>
