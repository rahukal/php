<?
...

	 {
	   ...
	   if($_POST['changeStatus']=='delete') 

		{
		   ...
		   $dbcon->execute_query("delete from tbl_manage_language where language_id in($id)");

		   $mess="Record deleted successfully.";

		   echo "<SCRIPT language=\"JavaScript\">window.location=\"language.php?mess=".base64_encode($mess)."\";</SCRIPT>";
...

		{
		   ...
		   $dbcon->execute_query("update tbl_manage_language set status='active' where language_id in($id)");
...

		{
		   ...
		   $dbcon->execute_query("update tbl_manage_language set status='inactive' where language_id in($id)");
	...
	$sql="select * from tbl_manage_language where 1";
	...
	if($orderBy=="") { 	$orderBy = "language_id"; }
    ...
    <div id="body-wrapper"> <!-- Wrapper for the radial gradient background -->
     ...
     <div id="main-content"> <!-- Main Content Section with everything -->
		...
		<div class="align-left">Records Per Page:
			...
			<select name="pagesize" id="pagesize" onchange="location.href='language.php?&pagesize='+this.value">
			...
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
			  ...
			  <tr>
				...
				<td class="content-box-header">
					...
					<b style='font-size:15px;'>Languages</b> 

				  

					<form name="createGroup" method="post" action="add_language.php">

                    <div style="float:right">

                    <input class="button"  type="submit" name="creategroup" value="Add language" >
    ...
    ?>
		  ...
		  <tr>
			 ...
			 <th width="2%" bgcolor="#FFFFFF">
              ...
              <th align="left" width="20%" bgcolor="#FFFFFF"><strong>Language Name</strong></th>
			  ...
			  <tr>
				...
				<td align="center" bgcolor='<?=$CL?>'>
                	...
                	<input name="arr_pd_ids[]" id="arr_pd_ids[]" value="<?=$records['language_id']?>" type="checkbox">

                    

                </td>

             	  <td bgcolor='<?=$CL?>'><? echo $records['language_name'];?></td>
                 ...
                 <td align="center" bgcolor='<?=$CL?>'><span style="cursor:pointer" onclick="return actionPerform('update_language.php','<?=$records['language_id']?>','language_id','frm');">
