<?
	...
	require 'conn/checkSession.php';
	$event_category_id	= $_REQUEST['event_category_id'];
	if(isset($_POST['submit'])) 
	{
	$content=array("event_category_name"=>$_POST['event_category_name'],"news_category"=>$_POST['news_category'],"category_id"=>$_POST['category_id'],"status"=>$_POST['status']);
		$condition=" where event_category_id='$event_category_id'";
		$dbcon->update_query("tbl_event_category",$content,$condition);
...
$query	="select * from tbl_event_category where event_category_id='$event_category_id'";
...
<div id="body-wrapper">
  ...
  <div id="main-content">
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%">
      <tbody>
        <tr>
          <td class="content-box-header"><b style='font-size:15px;'>Update event category</b></td>
        </tr>
      </tbody>
    </table>
    <form action='#' method='post' enctype="multipart/form-data" onSubmit="return check_form(this)" name="frm">
      <input type="hidden" value="<?=$Records['event_category_id']?>" name="event_category_id" />
        ...
        <tr>
          <td><table width="100%"  border="0" cellspacing="7" cellpadding="3" >
			...
			<tr>
                ...
                <td width="81%" height="25" valign="top" ><input type="search" class="txtbox" style="width:250px;" name="news_category" required="required" value="<?=$Records['news_category']?>" id="news_category" /></td>
              </tr>
              <tr>
                <th width="19%" align="right" valign="top">Select Category : </th>
                <td width="81%" height="25" valign="top"><select name="category_id" class="selectbox" id="category_id">
                    <?php 
						 if($countDropDown>0)
						  {  $i=0;
