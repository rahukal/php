<?
...

	 {
	   ...
	   if($_POST['changeStatus']=='delete') 

		{
		   ...
		   $dbcon->execute_query("delete from tbl_manage_movies where movie_id in($id)");

		   $mess="Record deleted successfully.";

		   echo "<SCRIPT language=\"JavaScript\">window.location=\"manage_movie.php?mess=".base64_encode($mess)."\";</SCRIPT>";
...

		{
		   ...
		   $dbcon->execute_query("update tbl_manage_movies set status='active' where movie_id in($id)");
...

		{
		   ...
		   $dbcon->execute_query("update tbl_manage_movies set status='inactive' where movie_id in($id)");
	...
	$sql="select * from tbl_manage_movies where 1";
    ...
    <div id="body-wrapper"> <!-- Wrapper for the radial gradient background -->
     ...
     <div id="main-content"> <!-- Main Content Section with everything -->
		...
		<div class="align-left">Records Per Page:
			...
			<select name="pagesize" id="pagesize" onchange="location.href='manage_movie.php?&pagesize='+this.value">
			...
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
			  ...
			  <tr>
				...
				<td class="content-box-header">
					...
					<form name="createGroup" method="post" action="add_manage_movie.php">

                    <div style="float:right">

                    <input class="button"  type="submit" name="creategroup" value="Add movies" >
    ...
    ?>
		  ...
		  <tr>
			 ...
			 <th width="2%" bgcolor="#FFFFFF">
              ...
              <th align="left" width="20%" bgcolor="#FFFFFF"><strong>ID</strong></th>

             

              <th align="left" width="7%" bgcolor="#FFFFFF"><strong>Name</strong></th>
              <th align="left" width="7%" bgcolor="#FFFFFF"><strong>Poster</strong></th>
			  ...
			  <tr>
				...
				<td align="center" bgcolor='<?=$CL?>'>
                	...
                	<input name="arr_pd_ids[]" id="arr_pd_ids[]" value="<?=$records['movie_id']?>" type="checkbox">

                    

                </td>

             	  <td bgcolor='<?=$CL?>'><? echo $records['movie_id'];?></td>
             	  <td bgcolor='<?=$CL?>'><? echo $records['name'];?></td>
        <td bgcolor='<?=$CL?>'> <img src="upload/<?echo $records['poster']; ?>" style="width:100px; height:100px;"></td>
                 ...
                 <td align="center" bgcolor='<?=$CL?>'><span style="cursor:pointer" onclick="return actionPerform('update_manage_movie.php','<?=$records['movie_id']?>','movie_id','frm');">
