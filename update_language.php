<?
	...
	{
	$content=array("language_name"=>$_POST['language_name'],"status"=>$_POST['status']);
		$condition=" where language_id='$language_id'";
		$dbcon->update_query("tbl_manage_language",$content,$condition);
		$mess="Record updated successfully.";
		$url="language.php?mess=".base64_encode($mess);
		redirectPage($url);
	}


$query	="select * from tbl_manage_language where language_id='$language_id'";
...
<script type="text/javascript">
    ...
    function check_form(thisform)
    {
      with (thisform)
        {
         if ((isBlank(language_name,"Please enter language name .") && InitialSpace('language_name') )==false)
          {
          	language_name.focus();return false;
          }
           if ((isBlank(title,"Please enter title.") && InitialSpace('title') )==false)  
          {_title.focus();return false;}                             
...
<div id="body-wrapper">
  ...
  <div id="main-content">
    ...
    <form action='#' method='post' enctype="multipart/form-data" onSubmit="return check_form(this)" name="frm">
      <input type="hidden" value="<?=$Records['language_id']?>" name="language_id" />
        ...
        <tr>
          <td><table width="100%"  border="0" cellspacing="7" cellpadding="3" >
...

			{
              ...
              <tr>
                <th width="19%" align="right" valign="top">language name : </th>
                <td width="81%" height="25" valign="top" ><input type="search" class="txtbox" style="width:250px;" name="language_name" value="<?=$Records['language_name']?>" id="language_name" required="required" /></td>
              </tr>
                ...
                <td colspan="2" class="last" align="left" style="padding-left:210px;"><input name ="submit" type="submit" class="button" value="Submit" onclick="">
                  <input name="Submit623" type="button" class="button" value="Cancel" onclick="javascript:window.location='language.php'"></td>
              </tr>
            </table></td>
        </tr>
      </table>
