<?
...

	 {
	   ...
	   if($_POST['changeStatus']=='delete') 

		{
		   ...
		   $dbcon->execute_query("delete from tbl_cms where cms_id in($id)");

		   $mess="Record deleted successfully.";

		   echo "<SCRIPT language=\"JavaScript\">window.location=\"cms.php?mess=".base64_encode($mess)."\";</SCRIPT>";
...

		{
		   ...
		   $dbcon->execute_query("update tbl_cms set status='active' where cms_id in($id)");
...

		{
		   ...
		   $dbcon->execute_query("update tbl_cms set status='inactive' where cms_id in($id)");
	...
	$sql="select * from tbl_cms where 1";
    ...
    <div id="body-wrapper"> <!-- Wrapper for the radial gradient background -->
     ...
     <div id="main-content"> <!-- Main Content Section with everything -->
		...
		<div class="align-left">Records Per Page:
			...
			<select name="pagesize" id="pagesize" onchange="location.href='cms.php?&pagesize='+this.value">
			...
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
			  ...
			  <tr>
				...
				<td class="content-box-header">
					...
					<b style='font-size:15px;'>CMS</b> 

				  

					<form name="createGroup" method="post" action="add_cms.php">

                    <div style="float:right">

                    <input class="button"  type="submit" name="creategroup" value="Add CMS" >
  ...
  if($countrecord>0) {
    ...
    ?>
		  ...
		  <tr>
            ...
            <th align="left" width="20%" bgcolor="#FFFFFF"><strong> Description</strong></th>
			  ...
			  <tr>
				...
				<td align="center" bgcolor='<?=$CL?>'>
                	...
                	<input name="arr_pd_ids[]" id="arr_pd_ids[]" value="<?=$records['cms_id']?>" type="checkbox">
                 ...
                 <td align="center" bgcolor='<?=$CL?>'><span style="cursor:pointer" onclick="return actionPerform('update_cms.php','<?=$records['cms_id']?>','cms_id','frm');">
