<?
	...
	$content=array("city_name"=>$_POST['city_name'],"city_code"=>$_POST['city_code'],"country_id"=>$_POST['country_id'],"state_id"=>$_POST['state_id'],"status"=>$_POST['status']);
		$condition=" where city_id='$city_id'";
		$dbcon->update_query("tbl_city",$content,$condition);
...
$sqlDropDown="select * from tbl_country ";
...
<?php
/*
$sqlDrop="select * from tbl_state where 1";
      ...
      req.onreadystatechange = function() {
        if (req.readyState == 4) {
          ...
          if (req.status == 200) {            
            ...
            document.getElementById('citydiv').innerHTML='<select name="city_id" class="selectbox">'+
...
<div id="body-wrapper">
  ...
  <div id="main-content">
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%">
      <tbody>
        <tr>
          <td class="content-box-header"><b style='font-size:15px;'>Update City</b></td>
        </tr>
      </tbody>
    </table>
    <form action='#' method='post' enctype="multipart/form-data" onSubmit="return check_form(this)" name="frm">
      <input type="hidden" value="<?=$Records['city_id']?>" name="city_id" />
  ...
  <option>Select city</option>
			  ...
			  <tr>
                ...
                <td width="81%" height="25" valign="top" ><input type="search" class="txtbox" style="width:250px;" name="city_code" required="required" value="<?=$Records['city_code']?>" id="city_code" /></td>
              </tr>	 	
