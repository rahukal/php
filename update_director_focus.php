<?
	...
	require 'conn/checkSession.php';
	$director_focus_id	= $_REQUEST['director_focus_id'];
  ...
  //********uploading finishing*********//
	$content=array("title"=>$_POST['title'],"content"=>$_POST['content'],"status"=>$_POST['status'],"url"=>$_POST['url'],"image"=>$image);
		$condition=" where director_focus_id='$director_focus_id'";
		$dbcon->update_query("tbl_director_focus",$content,$condition);
		$mess="Record updated successfully.";
		$url="director_focus.php?mess=".base64_encode($mess);
		redirectPage($url);
	}


$query	="select * from tbl_director_focus where director_focus_id='$director_focus_id'";
...
<div id="body-wrapper">
  ...
  <div id="main-content">
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%">
      <tbody>
        <tr>
          <td class="content-box-header"><b style='font-size:15px;'>Update Director Focus</b></td>
        </tr>
      </tbody>
    </table>
    <form action='#' method='post' enctype="multipart/form-data" onSubmit="return check_form(this)" name="frm">
      <input type="hidden" value="<?=$Records['director_focus_id']?>" name="director_focus_id" />
      <table border="0" cellpadding="0" cellspacing="0">
       ...
       <th></th>
        ...
        <tr>
                ...
                <td width="81%" height="25" valign="top" ><input type="search" class="txtbox" style="width:250px;" name="url" value="<?=$Records['url']?>" id="url" /></td>
              </tr>
                ...
                <td colspan="2" class="last" align="left" style="padding-left:210px;"><input name ="submit" type="submit" class="button" value="Submit" onclick="">
                  <input name="Submit623" type="button" class="button" value="Cancel" onclick="javascript:window.location='director_focus.php'"></td>
              </tr>
            </table></td>
        </tr>
      </table>
