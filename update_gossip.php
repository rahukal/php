<?
  ...
  //********uploading finishing*********//
	...
	$content=array("title"=>$_POST['title'],"content"=>$_POST['content'],"status"=>$_POST['status'],"url"=>$_POST['url'],"image"=>$image);
		$condition=" where gossip_id='$gossip_id'";
		$dbcon->update_query("tbl_gossip",$content,$condition);
...
$query	="select * from tbl_gossip where gossip_id='$gossip_id'";
...
<div id="body-wrapper">
  ...
  <div id="main-content">
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%">
      <tbody>
        <tr>
          <td class="content-box-header"><b style='font-size:15px;'>Update Gossip</b></td>
        </tr>
      </tbody>
    </table>
    <form action='#' method='post' enctype="multipart/form-data" onSubmit="return check_form(this)" name="frm">
      <input type="hidden" value="<?=$Records['gossip_id']?>" name="gossip_id" />
