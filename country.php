...

	 {
	   ...
	   if($_POST['changeStatus']=='delete') 

		{
		   ...
		   $dbcon->execute_query("delete from tbl_country where country_id in($id)");
...

		{
		   ...
		   $dbcon->execute_query("update tbl_country set status='active' where country_id in($id)");
...

		{
		   ...
		   $dbcon->execute_query("update tbl_country set status='inactive' where country_id in($id)");
			...
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
			  ...
			  <tr>
				...
				<td class="content-box-header">
					...
					<b style='font-size:15px;'>Countries</b> 

				  

					<form name="createGroup" method="post" action="add_country.php">

                    <div style="float:right">

                    <input class="button"  type="submit" name="creategroup" value="Add Country" >
    ...
    ?>
		  ...
		  <tr>
			 ...
			 <th width="2%" bgcolor="#FFFFFF">
              ...
              <th align="left" width="20%" bgcolor="#FFFFFF"><strong>country Name</strong></th>

             <th align="left" width="20%" bgcolor="#FFFFFF"><strong>country Code</strong></th>
			  ...
			  <tr>
				...
				<td align="center" bgcolor='<?=$CL?>'>
                	...
                	<input name="arr_pd_ids[]" id="arr_pd_ids[]" value="<?=$records['country_id']?>" type="checkbox">

                    

                </td>

             	  <td bgcolor='<?=$CL?>'><? echo $records['country_name'];?></td>
             	  <td bgcolor='<?=$CL?>'><? echo $records['country_code'];?></td>
                 ...
                 <td align="center" bgcolor='<?=$CL?>'><span style="cursor:pointer" onclick="return actionPerform('update_country.php','<?=$records['country_id']?>','country_id','frm');">
