...
{
	$title=$_POST['title'];
	$checkIfExist = "select * from tbl_director_focus where title='".$title."'";
	...
	$dbcon->insert_query("tbl_director_focus",$content);
...
<div id="body-wrapper">
  ...
  <div id="main-content">
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%">
      <tbody>
        <tr>
          <td class="content-box-header"><b style='font-size:15px;'>Add Director focus</b></td>
        </tr>
      </tbody>
    </table>
