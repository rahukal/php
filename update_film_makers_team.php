<?
	...
	require 'conn/checkSession.php';
	$film_makers_id	= $_REQUEST['film_makers_id'];
  ...
  //********uploading finishing*********//
	...
	$content=array("name"=>$_POST['name'],"content"=>$_POST['content'],"team_type"=>$_POST['team_type'],"status"=>$_POST['status'],"image"=>$image);
		$condition=" where film_makers_id='$film_makers_id'";
		$dbcon->update_query("tbl_film_makers",$content,$condition);
...
$query	="select * from tbl_film_makers where film_makers_id='$film_makers_id'";
...
<div id="body-wrapper">
  ...
  <div id="main-content">
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%">
      <tbody>
        <tr>
          <td class="content-box-header"><b style='font-size:15px;'>Update Film Makers Team</b></td>
        </tr>
      </tbody>
    </table>
    <form action='#' method='post' enctype="multipart/form-data" onSubmit="return check_form(this)" name="frm">
      <input type="hidden" value="<?=$Records['film_makers_id']?>" name="film_makers_id" />
          ...
          <td><table width="100%"  border="0" cellspacing="7" cellpadding="3" >
...

			{
              ...
              <tr>
                ...
                <td width="81%" height="25" valign="top" ><select name="team_type" id="team_type">                    <option value="our_teams" <? if($Records['team_type']=='our_teams') { echo "selected";} ?>>Our team</option>
