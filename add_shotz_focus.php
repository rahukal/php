...
{
	$title=$_POST['title'];
	$checkIfExist = "select * from tbl_shotz_focus where title='".$title."'";
	...
	$dbcon->insert_query("tbl_shotz_focus",$content);
...
<div id="body-wrapper">
  ...
  <div id="main-content">
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%">
      <tbody>
        <tr>
          <td class="content-box-header"><b style='font-size:15px;'>Add Shotz focus</b></td>
        </tr>
      </tbody>
    </table>
