...
{
	$name=$_POST['name'];
	$checkIfExist = "select * from tbl_team where name='".$name."'";
...
$time=time();
	...
	$dbcon->insert_query("tbl_team",$content);
...
<div id="body-wrapper">
  ...
  <div id="main-content">
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%">
      <tbody>
        <tr>
          <td class="content-box-header"><b style='font-size:15px;'>Add Team </b></td>
        </tr>
      </tbody>
    </table>
          ...
          <td><table width="100%"  border="0" cellspacing="7" cellpadding="3" >
              ...
              echo '<tr> 
               ...
               <tr>
                ...
                <td width="81%" height="25" valign="top" ><select name="team_type" id="team_type" class="selectbox">
                    <option selected="selected" value="0">Select Team Type</option>
...
<tr>
                ...
                <td width="81%" height="25" valign="top" ><select name="status" id="status">
                     <option selected="selected" value="0">Select Status</option>
                                   ...
                                   <option value="inactie">Inactive</option>
