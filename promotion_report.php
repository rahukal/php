<?
...

	 {
	   ...
	   if($_POST['changeStatus']=='delete') 

		{
		   ...
		   $dbcon->execute_query("delete from tbl_promotion_report where promotion_report_id in($id)");

		   $mess="Record deleted successfully.";

		   echo "<SCRIPT language=\"JavaScript\">window.location=\"promotion_report.php?mess=".base64_encode($mess)."\";</SCRIPT>";
...

		{
		   ...
		   $dbcon->execute_query("update tbl_promotion_report set status='active' where promotion_report_id in($id)");
...

		{
		   ...
		   $dbcon->execute_query("update tbl_promotion_report set status='inactive' where promotion_report_id in($id)");
	...
	$sql="select * from tbl_promotion_report where 1";
	...
	if($orderBy=="") { 	$orderBy = "promotion_report_id"; }
    ...
    <div id="body-wrapper"> <!-- Wrapper for the radial gradient background -->
     ...
     <div id="main-content"> <!-- Main Content Section with everything -->
		...
		<div class="align-left">Records Per Page:
			...
			<select name="pagesize" id="pagesize" onchange="location.href='promotion_report.php?&pagesize='+this.value">
			...
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
			  ...
			  <tr>
				...
				<td class="content-box-header">
					...
					<b style='font-size:15px;'>All Promotions</b> 
        ...
        <input type="hidden" name="promotion_report_id" id="promotion_report_id">
    ...
    ?>
		  ...
		  <tr>
			 ...
			 <th width="2%" bgcolor="#FFFFFF">
              ...
              <th align="left" width="20%" bgcolor="#FFFFFF"><strong>S.NO.</strong></th>

             <th align="left" width="20%" bgcolor="#FFFFFF"><strong>Promotion</strong></th>
             <th align="left" width="20%" bgcolor="#FFFFFF"><strong>Total Quantity</strong></th>
             <th align="left" width="20%" bgcolor="#FFFFFF"><strong>Applied</strong></th>
			  ...
			  <tr>
				...
				<td align="center" bgcolor='<?=$CL?>'>
                	...
                	<input name="arr_pd_ids[]" id="arr_pd_ids[]" value="<?=$records['promotion_report_id']?>" type="checkbox">

                    

                </td>

             	  <td bgcolor='<?=$CL?>'><? echo $records['promotion_report_id'];?></td>

                  <td bgcolor='<?=$CL?>'><? echo $records['promotion'];?></td>
                  <td bgcolor='<?=$CL?>'><? echo $records['total_quantity'];?></td>

				 <td bgcolor='<?=$CL?>'><? echo $records['applied'];?></td>
		...
		<td bgcolor='<?=$CL?>'><? echo $records['status'];?></td>
                 ...
                 <td align="center" bgcolor='<?=$CL?>'><span style="cursor:pointer" onclick="return actionPerform('update_promotion_report.php','<?=$records['promotion_report_id']?>','promotion_report_id','frm');">
