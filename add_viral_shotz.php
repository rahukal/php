...
{
	$title=$_POST['title'];
	$checkIfExist = "select * from tbl_viral_shotz where title='".$title."'";
	...
	//***********file Upload End**************** 
	$content=array("title"=>$_POST['title'],"content"=>$_POST['content'],"youtube_url"=>$_POST['youtube_url'],"status"=>$_POST['status']);
	$dbcon->insert_query("tbl_viral_shotz",$content);
...
<tr>
              ...
              <tr>
                <th width="19%" align="right" valign="top">You Tube Url </th>
                <td width="81%" height="25" valign="top" ><input type="search" name="youtube_url" id="youtube_url" style="width:250px;"required="required" /></td>
              </tr>
