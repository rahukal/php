<?
	...
	$content=array("country_name"=>$_POST['country_name'],"country_code"=>$_POST['country_code'],"status"=>$_POST['status']);
		...
		$dbcon->update_query("tbl_country",$content,$condition);
...
<div id="body-wrapper">
  ...
  <div id="main-content">
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%">
      <tbody>
        <tr>
          <td class="content-box-header"><b style='font-size:15px;'>Update Country</b></td>
        </tr>
      </tbody>
    </table>
    <form action='#' method='post' enctype="multipart/form-data" onSubmit="return check_form(this)" name="frm">
      <input type="hidden" value="<?=$Records['country_id']?>" name="country_id" />
          ...
          <td><table width="100%"  border="0" cellspacing="7" cellpadding="3" >
...

			{
              ...
              <tr>
                ...
                <td width="81%" height="25" valign="top" ><input type="search" class="txtbox" style="width:250px;" name="country_name" required="required" value="<?=$Records['country_name']?>" id="country_name" /></td>
              </tr>

			  	 	<tr>
                <th width="19%" align="right" valign="top">Country code : </th>
                <td width="81%" height="25" valign="top" ><input type="search" class="txtbox" style="width:250px;" name="country_code" required="required" value="<?=$Records['country_code']?>" id="country_code" /></td>
              </tr>
